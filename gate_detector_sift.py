...
img_train = cv2.imread(fname + 'img_55.png') # trainImage
...
img4 = cv2.drawMatchesKnn(img_query_corp, kp1, img_train, kp2, matches, None, flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
