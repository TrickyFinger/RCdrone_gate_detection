...
# initialize the bounding box coordinatess of the object we are going
# to track
initBB = None
...
fps = None
'''
image_dir_name = os.getcwd() + '/WashingtonOBRace/WashingtonOBRace/'
image_type = 'png'
image_names = []
...
while True:
	...
	frame = cv2.imread(image_names[idx])
